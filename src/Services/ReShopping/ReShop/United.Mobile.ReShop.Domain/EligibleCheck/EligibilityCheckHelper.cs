...
namespace United.Mobile.EligibleCheck.Domain
{
    public class EligibilityCheckHelper
    {
        ...
        public static string GetSDCRedirect3dot0Url(MOBRESHOPChangeEligibilityRequest request,
            MOBRESHOPChangeEligibilityResponse response = null, bool enableCheckinReshop30Redirect = false)
        {
            bool isAward = false;
            ...
            return GetTripDetailRedirect3dot0Url(request.RecordLocator, request.LastName, "CSDC",
                 ...
                 ddate: ddate, guid: request.CheckinSessionKey, isAward: isAward, enableCheckinReshop30Redirect: enableCheckinReshop30Redirect);
        }
        ...
        public static string GetTripDetailRedirect3dot0Url
            ...
            string guid = "", bool isAward = false,bool enableCheckinReshop30Redirect = false)
        {
            ...
            {
                //Birkan - Checkin 3.0 URL changes
                if (enableCheckinReshop30Redirect) {
                    urlPatternFSR = _configuration.GetValue<string>("CheckInRedirect30Changes");
                    baseUrl = _configuration.GetValue<string>("CheckInRedirectBaseURL");

                    string inputdatapattern = "cartid?edata={0}&from={1}&guid={2}&trips={3}&travelers={4}";
                    return string.Format(urlPatternFSR, baseUrl, languagecode, isAward ? "awd" : "rev",
                        string.Format(inputdatapattern, encodedstring, from, guid, trips, travelers));
                }
        ...
        public static async System.Threading.Tasks.Task MapPersistedReservationToMOBSHOPReservation(MOBSHOPReservation reservation,
            United.Mobile.Model.Shopping.Reservation persistedReservation)
        {
            ...
            reservation.HasJSXSegment = persistedReservation.HasJSXSegment;
        ...
        {
            return GeneralHelper.IsApplicationVersionGreater(appId, appVersion, "AndroidVersionChangeWebSSO", "iPhoneVersionChangeWebSSO", "", "", true, _configuration);
        }
        ...
        {
            return GeneralHelper.IsApplicationVersionGreater(appId, appVersion, "AndroidInfantInLapVersion", "iPhoneInfantInLapVersion", "", "", true, _configuration);
        }
        ...
        {
            return GeneralHelper.IsApplicationVersionGreater(appId, appVersion, "AndroidReshopCheckinEligibleMsgVersion", "iPhoneReshopCheckinEligibleMsgVersion", "", "", true, _configuration);
        }
    }
}
