...
namespace United.Mobile.Test.MemberProfile.Tests
{
    public class TestDataGenerator
    {
        ...
        public static IEnumerable<object[]> GetProfileCSL_CFOP_flow()
        {
            TestDataSet testDataSet = new TestDataSet();
        ...
        public static IEnumerable<object[]> GetProfileOwner_flow1()
        {
            TestDataSet testDataSet = new TestDataSet();
        ...
        public static IEnumerable<object[]> GetProfileOwner_flow2()
        {
            TestDataSet testDataSet = new TestDataSet();
            yield return testDataSet.set7_1();

        }
        public static IEnumerable<object[]> UpdateTravelersInformation_Request1()
        {
            TestDataSet testDataSet = new TestDataSet();
            yield return testDataSet.set6_1();

        }
        public static IEnumerable<object[]> UpdateTravelersInformation_Flow()
        {
            TestDataSet testDataSet = new TestDataSet();
            yield return testDataSet.set6_2();



        }

        public static IEnumerable<object[]> GetEmpProfileCSL_CFOP_Flow()
        {
            TestDataSet testDataSet = new TestDataSet();
            yield return testDataSet.set2();
