...
{
    [Serializable()]
    public class MOBUpgradeCabinSegment : MOBSegment
    {
        ...
        private List<MOBUpgradeOption> prices;
        private List<MOBUpgradeOption> points;
        private List<MOBUpgradeOption> miles;
        ...
        public MOBAircraft Aircraft { get { return this.aircraft; } set { this.aircraft = value; } }
        public string FlightTime { get { return this.flightTime; } set { this.flightTime = value; } }
        public List<MOBUpgradeOption> Prices { get { return this.prices; } set { this.prices = value; } }
        public List<MOBUpgradeOption> Points { get { return this.points; } set { this.points = value; } }
        public List<MOBUpgradeOption> Miles { get { return this.miles; } set { this.miles = value; } }
    }
}
