...
namespace United.Mobile.Model.Shopping
{
    ...
    public class MOBSHOPShoppingProduct
    {
        ...
        private string priceApplyLabelText;

        public string PriceApplyLabelText
        {
            get { return priceApplyLabelText; }
            set { priceApplyLabelText = value; }
        }
        ...
        private string milesPlusMoneyDisplayValue = string.Empty;

        public string MilesPlusMoneyDisplayValue
        {
            get { return milesPlusMoneyDisplayValue; }
            set { milesPlusMoneyDisplayValue = string.IsNullOrEmpty(value) ? string.Empty : value.Trim(); }
        }

        private MOBStyledText priceStyle { get; set; }

        public MOBStyledText PriceStyle 
        {
            get { return priceStyle; }
