...
namespace United.Mobile.Model.Shopping
{
    ...
    public class FareLock
    {
        ...
        private List<FareLockProduct> fareLockProducts;
        [XmlArrayItem("MOBSHOPFareLockProduct")]
        public List<FareLockProduct> FareLockProducts
        {
        ...
        public FareLock()
        {
            FareLockTermsAndConditions = new List<string>();
            FareLockProducts = new List<FareLockProduct>();
        }
