...
//using United.Services.FlightShopping;
...
namespace United.Mobile.Model.Shopping
{
    ...
    public class DOTBaggageInfo
    {
        ...
        public List<BagFeesPerSegment> BaggageFeesPerSegment
        {
        ...
        public void SetDatabaseBaggageInfo(DOTBaggageInfo databaseBaggageInfo)
        {
        ...
        public void SetMerchandizingServicesBaggageInfo(DOTBaggageInfo merchBaggageInfo)
        {
            if (merchBaggageInfo.ErrorMessage !=null && merchBaggageInfo.ErrorMessage!="")//.IsNullOrEmpty())
            {
                Title1 = string.Empty;
                Title2 = string.Empty;
                Title3 = string.Empty;
