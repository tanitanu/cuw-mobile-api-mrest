...
namespace United.Definition.SeatCSL30
{
    ...
    public partial class Identifiers
    {
        ...
        [Newtonsoft.Json.JsonProperty("isAdjacentPreferredSeatsModified", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool IsAdjacentPreferredSeatsModified { get; set; }

        [Newtonsoft.Json.JsonProperty("numberOfPreferredSeatsOpened", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int NumberOfPreferredSeatsOpened { get; set; }

        [Newtonsoft.Json.JsonProperty("adjacentSeatsList", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string AdjacentSeatsList { get; set; }
    ...
    public partial class Seat
    {
        ...
        [Newtonsoft.Json.JsonProperty("isDoorExit", Required = Newtonsoft.Json.Required.Always)]
        public bool IsDoorExit { get; set; }

        [Newtonsoft.Json.JsonProperty("oldSellableSeatCategory", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string oldSellableSeatCategory { get; set; }
    }
    ...
    public partial class Coupon
    {
        ...
        [Newtonsoft.Json.JsonProperty("anscillaryProductCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string AnscillaryProductCode { get; set; }
    ...
    public partial class SeatMapRequest
    {
        ...
        [Newtonsoft.Json.JsonProperty("hasSSR", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class FlightSegments
    {
        ...
        public System.Collections.Generic.ICollection<Coupon> Coupons { get; set; }
