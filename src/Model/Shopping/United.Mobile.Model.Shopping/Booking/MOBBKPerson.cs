...
namespace United.Mobile.Model.Shopping.Booking
{
    ...
    public class MOBBKPerson
    {
        ...
        public MOBBKCountry CountryOfResidence
        {
            get
            {
        ...
        public MOBBKCountry Nationality
        {
            get
            {
        ...
        public string DisplayName
        {
            get
            {
                return CapitalizeFirstChar(this.GivenName + " " + this.surname);
            }
        }
        ...
        public List<MOBBKDocument> Documents
        {
            get
            {
        ...
        private string CapitalizeFirstChar(string text)
        {
            ...
            return cultInfo.ToTitleCase(text.ToLower());
        }
    }
}
