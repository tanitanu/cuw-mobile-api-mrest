...
{
    public class FSRWithResultSuggestNearbyOrigin : IRule<MOBFSRAlertMessage>
    {
        ...
        public FSRWithResultSuggestNearbyOrigin(ShopResponse cslShopResponse, MOBSHOPShopRequest restShopRequest, IConfiguration configuration)
        {
        ...
        public bool ShouldExecuteRule()
        {
            return (_cslShopResponse != null && _cslShopResponse.Trips != null && _cslShopResponse.Trips.Count > _tripIndex
                ...
                && _cslShopResponse.Trips[_tripIndex].OriginTriggeredAirport);
        }
        ...
        public async Task<MOBFSRAlertMessage> Execute()
        {
            ...
            return new MOBFSRAlertMessage()
            {
                ...
                BodyMessage = string.Format(bodyMsg, _cslShopResponse.Trips[_tripIndex].OriginDecoded),
