...
{
    public class FSRWithResultSuggestNearbyDestination : IRule<MOBFSRAlertMessage>
    {
        ...
        public FSRWithResultSuggestNearbyDestination(ShopResponse cslShopResponse, MOBSHOPShopRequest restShopRequest, IConfiguration configuration)
        {
        ...
        public bool ShouldExecuteRule()
        {
            return (_cslShopResponse != null && _cslShopResponse.Trips != null && _cslShopResponse.Trips.Count > _tripIndex
                    ...
                    && _cslShopResponse.Trips[_tripIndex].DestinationTriggeredAirport);
        }
        ...
        public async Task<MOBFSRAlertMessage> Execute()
        {
            ...
            string bodyMsg = _configuration.GetValue<string>("FSRWithResultsSuggestNearbyOriginOrDestinationMsgBody");
            ...
            return new MOBFSRAlertMessage()
            {
                ...
                BodyMessage = string.Format(bodyMsg, _cslShopResponse.Trips[_tripIndex].DestinationDecoded),
                ...
                RestHandlerType = MOBFSREnhancementType.WithResultsSuggestNearByDestinations.ToString()
            };
        }
    }
}
