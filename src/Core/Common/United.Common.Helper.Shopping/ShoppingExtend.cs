...
namespace United.Common.Helper.Shopping
{
    public class ShoppingExtend
    {
        ...
        public async Task<bool> AddAmenitiesRequestToPersist(UpdateAmenitiesIndicatorsRequest shopAmenitiesRequest, string sessionID, string lastTripIndexRequested)
        {
            try
            {
                ...
                else
                {
                    ...
                    persistShopAmenitiesRequest.SessionId = sessionID;
                    persistShopAmenitiesRequest.CartId = shopAmenitiesRequest.CartId;
